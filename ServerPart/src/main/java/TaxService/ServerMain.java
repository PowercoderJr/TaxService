...
public class ServerMain
{
	public static void main(String[] args)
	{
		try (SessionFactory sessionFactory = new Configuration().configure().buildSessionFactory())
		{
			...
			strangeThingCRUD.add(new StrangeThing("admin", DigestUtils.sha256Hex(DigestUtils.sha256Hex("pass")), StrangeThing.Role.ADMIN));
			...
			for (String str : educations)
				educationCRUD.add(new Education(str));
			...
			for (String str : paytypes)
				paytypeCRUD.add(new Paytype(str));
			...
			for (String str : owntypes)
				owntypeCRUD.add(new Owntype(str));
